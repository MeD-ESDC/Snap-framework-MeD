...
function qsBeta(objAcc, paramObj) {
	...
	*/
	...
	this.qsNextQuestion = function (elem, qOffset, excpt) {
		...
		var target = $('#' + ancestrySTRARR[2] + '.qs-question')[0];
	...
	this.qsAnswerQuestion = function (elem, qMode) {
		...
		$(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].answers.elem).find(".no-selection-error").remove();
			...
			case "type-1":
				...
				if ($(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].answers.elem).find('input[type="radio"]:checked').length <= 0) {
					if (qMode !== "final-submit-all-at-once") {
						...
						if (!$(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].answers.elem).find(".no-selection-error").length) {
							var dynamicEle = $('<p class="no-selection-error" tabindex="0" style="margin-top: 3%;color: #a30000;">' + this.msgs.msgNoSelection + "</p>");
							$(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].elem).prepend(dynamicEle);
							dynamicEle.focus();
						}
					}
					return false;
			...
			case "type-2":
				...
				if ($(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].answers.elem).find('input[type="checkbox"]:checked').length <= 0 && !this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].empty_allowed) {
					if (qMode !== "final-submit-all-at-once") {
						...
						if (!$(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].answers.elem).find(".no-selection-error").length) {
							var dynamicEle = $('<p class="no-selection-error" tabindex="0" style="margin-top: 3%;color: #a30000;">' + this.msgs.msgNoMultiSelection + "</p>");
							$(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].elem).prepend(dynamicEle);
							dynamicEle.focus();
						}
					};
			...
			case "type-4":
				...
				if (dDEmpty) {
					if (qMode !== "final-submit-all-at-once") {
						...
						if (!$(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].answers.elem).find(".no-selection-error").length) {
							var dynamicEle = $('<p class="no-selection-error" tabindex="0" style="margin-top: 3%;color: #a30000;">' + this.msgs.msgEmptyDropDown + "</p>");
							$(this.activities[ancestryIDARR[0]].exercises[ancestryIDARR[1]].questions[ancestryIDARR[2]].elem).prepend(dynamicEle);
							dynamicEle.focus();
						}
					}
