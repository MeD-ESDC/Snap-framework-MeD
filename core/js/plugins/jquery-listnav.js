...
(function ($) {
	...
	// ajouter le bouton back to top si on a un overflow
    ...
    $.fn.listnav = function (options) {
        ...
        return this.each(function () {
            ...
            function addClasses() {
                ...
                $($list).children().each(function () {
                    ...
                    if (str !== '') {
                        ...
                        firstChar = removeDiacritics(str.charAt(0));
			...
			// remove accented/diacritics char
            ...
            function createLettersHtml() {
                ...
                for (var i = 1; i < letters.length; i++) {
                    if (html.length === 0) {
                        html.push('<a class="all" href="javascript:void(0);">'+ opts.allText + '</a><a class="_" href="#">0-9</a>');
                    }
                    html.push('<a class="' + letters[i] + '" href="javascript:void(0);">' + ((letters[i] === '-') ? '...' : letters[i].toUpperCase()) + '</a>');
                }
