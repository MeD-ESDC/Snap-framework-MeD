define([
   'underscore',
	...
	'plugins/skrollr/skrollr-csps',
	'popper/browserstate',
	'popper/browsercloseeventscript'

], function(_, $, labels, CoreSettings, Utils, Logger, History, Router, Legacy, MicroLearning, ScormController, DataController, Regular, LockingSystem, ObjNiveau, ObjSub, ObjSubUtils, PrintController, MobileInteractions, AdminMode, Navigation, Timeline, HelpController, SitemapController, ResourcesManager, Toolbox, Glossary, Resources, FavoriteController, ProgressController,googleAnalytics, Skrollr, BrowserState, CloseScript) {
	'use strict';
	...
	function navStructure() {
		this.version = "1.7.1"; //*DO NOT MODIFY. Auto-generated by build*//
		...
		this.initToolbox = function() {
			if ($(".toolbox").length > 0) {
				...
				//init Resources Manager
					this.resourcesManager = new ResourcesManager({master:this});
		...
		this.isLoaded = function(xhr) {
			...
			if (this.firstPageLoad) {
				...
				if($("html").hasClass("desktop")){
					...
					//console.log("Skrollr disabled for mobile")
				}
	...
	---------------------------------------------------------------------------------------*/		
		...
		this.generateSupermenu = function(){
