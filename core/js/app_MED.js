...
], function (_, $, labels, CoreSettings, Utils, Logger, History, Router, Legacy, MicroLearning, ScormController, DataController, Regular, LockingSystem, ObjNiveau, ObjSub, ObjSubUtils, PrintController, MobileInteractions, AdminMode, Navigation, Timeline, HelpController, SitemapController, Toolbox, Glossary, Resources, FavoriteController, ProgressController, googleAnalytics) {
	'use strict';
